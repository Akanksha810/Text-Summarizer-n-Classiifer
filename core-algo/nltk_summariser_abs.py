...
##Preparing the data
#list of contractions from from http://stackoverflow.com/questions/19790188/expanding-english-language-contractions-in-python
contractions = { 
"ain't": "am not",
"aren't": "are not",
"can't": "cannot",
...
#cleaning the unwanted characters, stopwords and format the text to create fewer nulls word embeddings
...
#find the number of words that are missing from CN, and are used more than the set threshold
missing_words = 0
threshold = 20
...
for word, count in word_counts.items():
        if count >=threshold or word in embeddings_index :
                ...
                value += 1
#special tokens for situation characterization
codes = ["<UNK>","<PAD>","<EOS>","<GO>"]

#adding codes to vocab
for code in codes :
        vocab_to_int[code] = len(vocab_to_int)

#dictionary to convery integers to words
int_to_vocab = {}
